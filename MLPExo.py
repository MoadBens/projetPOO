...
class NeuralNetMLP(object):
    ...
    def _feedforward(self, X, w1, w2, w3):
        ...
        w2 : array, shape = [n_output_units, n_hidden_units]
            Weight matrix for first hidden layer -> second hidden layer.
        w3 : array, shape = [n_hidden_units, n_features]
            Weight matrix for second hidden layer -> output layer.
        Returns
        ----------
        ...
        z3 : array, shape = [n_output_units, n_samples]
             Net input of second hidden layer.
        a3 : array, shape = [n_output_units, n_samples]
            Activation of second hidden layer.
        z4 : array, shape = [n_output_units, n_samples]
            Net input of output layer.
        a4 : array, shape = [n_output_units, n_samples]
    ...
    def _get_gradient(self, a1, a2, a3, a4, z2, z3, y_enc, w1, w2, w3):
        ...
        z3 : array, shape = [n_hidden, n_samples]
            Net input of hidden layer.
        y_enc : array, shape = (n_labels, n_samples)
            one-hot encoded class labels.
        w1 : array, shape = [n_hidden_units, n_features]
            Weight matrix for input layer -> first hidden layer.
        w2 : array, shape = [n_output_units, n_hidden_units]
            Weight matrix for first hidden layer -> second hidden layer.
        w3 : array, shape = [n_hidden_units, n_features]
            Weight matrix for second hidden layer -> output layer.
        ...
        grad3 : array, shape = [n_output_units, n_hidden_units]
            Gradient of the weight matrix w3.

        """
        # backpropagation
        sigma4 = a4 - y_enc  # erreur de classification
        z3 = self._add_bias_unit(z3, how='row')# pour régler erreur de sigma3
        sigma3 = w3.T.dot(sigma4) * self._sigmoid_gradient(z3)
        sigma3 = sigma3[1:, :]
        z2 = self._add_bias_unit(z2, how='row')  # pour régler erreur de sigma2
    ...
    def fit(self, X, y, print_progress=False):
        ...
        for i in range(self.epochs):  # Nombre de passage sur le dataset
            ...
            for idx in mini:
                # feedforward
                a1, z2, a2, z3, a3, z4, a4 = self._feedforward(X_data[idx], self.w1,
                                                       self.w2, self.w3)  # Ce que nous avons vu jusqu'à présent
                cost = self._get_cost(y_enc=y_enc[:, idx], output=a4, w1=self.w1, w2=self.w2, w3=self.w3)
                self.cost_.append(cost)

                # compute gradient via backpropagation
                #
                # Nous verrons plus en détails
                grad1, grad2, grad3 = self._get_gradient(a1=a1, a2=a2, a3=a3, a4=a4, z2=z2, z3=z3, y_enc=y_enc[:, idx], w1=self.w1,
